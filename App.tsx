    ...
    <div className="flex h-screen bg-[#0b141a] text-gray-200 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className={`flex-1 ${activeTab === 'chat' ? 'p-0 overflow-hidden' : 'p-8 overflow-y-auto'}`}>
          ...
          {activeTab === 'meta-templates' && <Templates instances={instances} currentUser={currentUser} />}
          {activeTab === 'meta-automations' && <MetaAutomations instances={instances} currentUser={currentUser} />}
