...
const targetBlock = `            agent: process.env.PROXY_URL ? new (require('https-proxy-agent').HttpsProxyAgent)(process.env.PROXY_URL) : new (require('https')).Agent({ 
                family: 4,
...
const replacement = `            agent: process.env.PROXY_URL ? 
...
console.log("Patched server.cjs with Smart Proxy Support (HTTP/SOCKS)");
